...
class ReferralUser : BaseFragment<ReferralUserFragmentBinding, ReferralListViewModel>(), BaseInterface {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        textView4.text=getString(R.string.referral_text_tag,AppConstants.CURRENCY_SYMBOL+settingFlowBean?.referral_receive_price, AppConstants.CURRENCY_SYMBOL+settingFlowBean?.referral_given_price)
        ...
        btn_share_referral.setOnClickListener {
            ...
            GeneralFunctions.shareApp(activity,getString(R.string.share_referral,perferenceHelper.getKeyValue(PrefenceConstants.USER_REFERRAL_ID,PrefenceConstants.TYPE_STRING).toString()
                    ,AppConstants.CURRENCY_SYMBOL+settingFlowBean?.referral_receive_price, AppConstants.CURRENCY_SYMBOL+settingFlowBean?.referral_given_price))
        }
