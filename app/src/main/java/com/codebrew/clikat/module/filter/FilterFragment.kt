...
class FilterFragment : BaseFragment<FragmentFilterBinding, FilterViewModel>(), FilterListAdapter.VarientListCallback,FilterNavigator {
    ...
    private fun settingLayout() {
        ...
        val disc_no = SpannableString(getString(R.string.disc_yes_text))
        disc_no.setSpan(RelativeSizeSpan(0.7f), 4, 28, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE)
        val disc_yes = SpannableString(getString(R.string.disc_no_text))
        disc_yes.setSpan(RelativeSizeSpan(0.7f), 3, 34, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE)
        rb_disc_yes.text = disc_no
        rb_disc_no.text = disc_yes


        val avail_yes = SpannableString(getString(R.string.avail_yes_text))
        avail_yes.setSpan(RelativeSizeSpan(0.7f), 4, 45, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE)
        val avail_no = SpannableString(getString(R.string.avail_no_text))
        avail_no.setSpan(RelativeSizeSpan(0.7f), 3, 54, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE)
