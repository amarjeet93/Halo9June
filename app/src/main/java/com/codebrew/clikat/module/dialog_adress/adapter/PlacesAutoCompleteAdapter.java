...
public class PlacesAutoCompleteAdapter extends RecyclerView.Adapter<PlacesAutoCompleteAdapter.PredictionHolder> implements Filterable {
    ...
    public PredictionHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ListSearchPlaceBinding binding = DataBindingUtil.inflate(LayoutInflater.from(viewGroup.getContext()), R.layout.list_search_place, viewGroup, false);
        binding.setColor(Configurations.colors);
        return new PredictionHolder(binding.getRoot());
    }
