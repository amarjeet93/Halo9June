...
class OfferProductListingFragment : BaseFragment<FragmentPackagetListingBinding, OfferProdListViewModel>(),
        SpecialListAdapter.OnProductDetail, OfferProdListNavigator, AddonFragment.AddonCallback, DialogListener {
    ...
    private fun settingLayout() {
        ...
        mAdapter = SpecialListAdapter(mOfferList,screenFlowBean?.app_type?:0,screenFlowBean?.is_single_vendor?:0,0,clientInform)
