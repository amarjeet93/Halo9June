...
class ImageListAdapter(val clickListener: UserChatListener) :
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        when (holder) {
            is ViewHolder -> {
                ...
                holder.bind(position,nightItem.messageData, clickListener,mType)
            }
    ...
    class ViewHolder private constructor(val binding: ItemPrescriptionImageBinding) :
        ...
        fun bind(position: Int, item: ImageListModel, clickListener: UserChatListener, mType: String) {
    ...
    class ImageViewHeader private constructor(val binding: HeaderPrescriptionImageBinding): RecyclerView.ViewHolder(binding.root) {
        ...
        fun bind(clickListener: UserChatListener) {
            binding.clickListener = clickListener
