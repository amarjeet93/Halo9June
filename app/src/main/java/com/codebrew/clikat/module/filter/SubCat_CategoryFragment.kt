...
class SubCat_CategoryFragment : Fragment(), SubCatCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (arguments != null && arguments!!.containsKey(ARG_PARAM3)) {
            position = arguments!!.getInt(ARG_PARAM3)
        }
    }
    ...
    override fun onAttach(context: Context) {
        ...
        /*    if (context instanceof OnSubcatCategoryListener) {
            mListener = (OnSubcatCategoryListener) context;
        } else {
