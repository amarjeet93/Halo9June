...
class SelectedQuestAdapter(private val mContext: Context, private val list: List<QuestionList?>):RecyclerView.Adapter<SelectedQuestAdapter.SelectQuestViewHolder>() {
    ...
    override fun onBindViewHolder(holder: SelectQuestViewHolder, position: Int) {
      ...
      //  val mQuest=list[position]
        ...
        selectAnsAdapter= SelectAnsAdapter(mContext,list[position]?.optionsList?: mutableListOf())
