...
import com.codebrew.clikat.modal.ExampleLoyalityPoints;
import com.codebrew.clikat.modal.ExamplePackagesSupplier;
import com.codebrew.clikat.modal.LoyalityCartServer;
...
import com.codebrew.clikat.modal.PojoSuccess1;
import com.codebrew.clikat.modal.SchedulerSent;
...
import com.codebrew.clikat.modal.other.ScheduleOrderModel;
...
public interface Api {
    ...
    Call<ApiResponse<UserExistModel>> isUserExist(@FieldMap HashMap<String, String> hashMap);

    /*12*/
    @FormUrlEncoded
    @POST("/customer_register_step_first")
    Call<PojoSignUp> signup_step_first(@Field("email") String email,
                                       @Field("deviceToken") String device_token,
                                       @Field("deviceType") int device_type,
                                       @Field("areaId") int area_id,
