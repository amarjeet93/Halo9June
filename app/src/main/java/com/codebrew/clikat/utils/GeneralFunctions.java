...
//        new SimpleDateFormat("MM/dd/yyyy KK:mm:ss a Z").format(dateObj);
    ...
    public static void shareApp(Context context,String shareBody) {
        ...
        sharingIntent.putExtra(Intent.EXTRA_TEXT, shareBody+" https://play.google.com/store/apps/details?id=com.Halo.user");
//        sharingIntent.putExtra(Intent.EXTRA_SUBJECT, context.getString(R.string.share_sub,R.string.app_name));
