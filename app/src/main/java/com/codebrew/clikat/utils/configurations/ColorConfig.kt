...
class ColorConfig(settingFlow: SettingData?) {
...
//-->DE216C
    ...
    @kotlin.jvm.JvmField
    var colorblack:String?="#000000"
    @kotlin.jvm.JvmField
    var colorBlue:String?="#979797"
    @kotlin.jvm.JvmField
    ...
    @kotlin.jvm.JvmField
    var textAppTitle: String? = "#515151"
    @kotlin.jvm.JvmField
    ...
    @kotlin.jvm.JvmField
    var toolbarColor: String? = "#212B36"
    @kotlin.jvm.JvmField
