...
import com.codebrew.clikat.module.rate_order.RatingViewModel
...
constructor(private val dataManager: DataManager) : ViewModelProvider.NewInstanceFactory() {
    ...
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        when {
            ...
            modelClass.isAssignableFrom(RatingViewModel::class.java) -> return RatingViewModel(dataManager) as T
            modelClass.isAssignableFrom(GetRateViewModel::class.java) -> return GetRateViewModel(dataManager) as T
            ...
            modelClass.isAssignableFrom(CheckoutViewModel::class.java) -> return CheckoutViewModel(dataManager) as T
